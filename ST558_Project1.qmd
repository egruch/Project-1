...
Now that we have the ability to pull data and in a nice clean format, we can write our own custom summary function with the tibble so we can gain insights about the data we are pulling.

Like our past function, this function checks the user's inputs to make sure they are valid. For numeric variables this function produces mean and standard deviation summaries and for categorical variables this function produces count summaries.
...
Let's test our function and produce some summaries.
